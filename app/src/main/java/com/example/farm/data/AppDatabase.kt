...
@Database(entities = [EncyclopediaCropData::class, EncyPotentialDiseaseData::class, FieldData::class, CoordinateData::class, PestsData::class, ResultData::class, UserData::class], version = 63, exportSchema = false)
